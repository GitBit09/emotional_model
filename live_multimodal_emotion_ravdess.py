...
# Emotion classes for face model (same as before)
...
# Load pretrained RAVDESS SVM model, scaler, and label encoder
...
def main():
    ...
    while True:
        ...
        # Voice prediction from latest audio
        if not audio_queue.empty():
            ...
            # Map voice_probs_raw to face emotion classes order (with zeros for missing)
        ...
        # Weighted fusion (weights adjustable)
