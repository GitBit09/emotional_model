...
def main():
    ...
    while True:
        ...
        voice_probs_raw = svm_model.predict_proba(audio_features)[0]  # (4,)
        ...
        cv2.putText(frame, "Audio: " + voice_pred, (10, 30),
        ...
        cv2.putText(frame, "Avg Combo: " + combined_emotion_avg, (10, 60),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255,255,0), 2)

        # Weighted fusion example (can adjust weights as needed)
        ...
        cv2.putText(frame, "Fusion Combo: " + combined_emotion_fusion, (10, 90),
